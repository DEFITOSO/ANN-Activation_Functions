# -*- coding: utf-8 -*-
"""ActivationfunctionTanh.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eANBWDnprZRlAIfRSTAfPc_REXpChc39
"""
...
def NOT_percep(x):
  ...
  # Test
print("NOT(0) = {}".format(NOT_percep(5)))
...
#Test
example1 = np.array([0.6,0.5])
example2 = np.array([1,0])
example3 = np.array([-150,150])
example4 = np.array([0,0])
